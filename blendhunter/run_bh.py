...
#path = '/Users/alacan/Documents/Cosmostat/Codes/BlendHunter/bh_22'
path = '/Users/alacan/Documents/Cosmostat/Codes/BlendHunter/bh_real'

bh = BlendHunter(weights_path=path + '/weights22')
...
np.save(path+'/BlendHunterData/test/test/pred_top22.npy', pred_top)

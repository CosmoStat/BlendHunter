...
"""Get ellipticity component for missed blends by bh and sep"""
def get_elli_errors(elli=None, errors=None):
    return [elli[i] for i in errors]
...
def plot_distribution(total_data, bh_data=None, sep_data=None, bh_distribution=False, sep_distribution=False,
    ...
    if bh_distribution:
        ...
        #Title
        fig.suptitle(TITLE, fontdict = {'family': 'serif','color':  'k','weight': 'heavy'},  fontsize=27)
        axs = axs.ravel()
